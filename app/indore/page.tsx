...
export const metadata: Metadata = {
  title: "Website Design in Indore | Professional Websites Starting ₹4,999 | SitesBanao",
  description:
    "Get a professional website for your Indore business starting ₹4,999. We serve businesses in Vijay Nagar, Palasia, Sapna Sangeeta, AB Road, South Tukoganj. 7-day delivery, mobile-friendly, SEO-ready.",
  keywords:
  ...
  openGraph: {
    title: "Website Design in Indore | Starting ₹4,999 | SitesBanao",
    description:
