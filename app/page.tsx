      ...
      <section id="portfolio" className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Real websites we&apos;ve built for real businesses</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
            {[
              { name: "Donor Aquarists", category: "Aquarium & Pet Store", city: "Jaipur", url: "https://donoraquarists.sitesbanao.com", img: "/portfolio/donor-aquarists.png", reviews: "4.5★ · 150+ reviews" },
              { name: "The Dogfather", category: "Pet Store & Grooming", city: "Jaipur", url: "https://thedogfather.sitesbanao.com", img: "/portfolio/the-dogfather.png", reviews: "4.6★ · 300+ reviews" },
              { name: "Evershine Kerala", category: "Restaurant", city: "Jaipur", url: "https://evershinekerala.sitesbanao.com", img: "/portfolio/evershine-kerala.png", reviews: "4.3★ · 500+ reviews" },
              ...
              <div key={i} className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300">
                <div className="aspect-video overflow-hidden relative">
                  ...
                  />
                  <span className={`absolute top-2 right-2 text-xs font-semibold px-2 py-0.5 rounded-full ${item.city === "Indore" ? "bg-purple-100 text-purple-700" : "bg-blue-100 text-blue-700"}`}>
                    {item.city}
                  </span>
                </div>
                <div className="p-4">
                  ...
                  <p className="text-yellow-600 text-xs mt-1">{item.reviews}</p>
                  <a
                    href={item.url}
                    target="_blank"
          ...
          <div className="text-center mt-12">
            <p className="text-gray-700 text-lg mb-4">Your business could be next! WhatsApp us for a free demo</p>
            <a
              href="https://wa.me/918209904262?text=Hi!%20I%20saw%20your%20portfolio%20and%20want%20a%20website%20for%20my%20business"
              className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-8 py-3 rounded-full font-bold transition shadow-lg"
            >
